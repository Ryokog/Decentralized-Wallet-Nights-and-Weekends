          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 20:
                ...
                base_namespaceObject.log.error(_context3.t1);
...
var BIG_NUMBER_ETH_MULTIPLIER = new (external_bignumber_js_default())("1");

// Setter Maps
var toBigNumber = {
  hex: function hex(n) {
    return typeof n === "string" ? new (external_bignumber_js_default())((0,util_namespaceObject.stripHexPrefix)(n), 16) : new (external_bignumber_js_default())(n, 16);
  },
  dec: function dec(n) {
...
function ethPrivatekeyUtils_getProviderHandlers(_ref) {
  ...
  return {
      ...
      var _getAccounts = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(_) {
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", ["0x".concat((0,util_namespaceObject.privateToAddress)(Buffer.from(privKey, "hex")).toString("hex"))]);
              case 1:
              case "end":
                return _context.stop();
            }
    ...
    processDecryptMessage: function processDecryptMessage(msgParams, _) {
      ...
      var stripped = (0,util_namespaceObject.stripHexPrefix)(msgParams.data);
...
function BnMultiplyByFraction(targetBN, numerator, denominator) {
  var numberBN = new (external_bn_js_default())(numerator);
  var denomBN = new (external_bn_js_default())(denominator);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                return _context2.abrupt("return", common_namespaceObject.Common.custom(customChainParams));
              case 6:
              case "end":
                return _context2.stop();
            }
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 9:
                ...
                return _context11.abrupt("return", (0,util_namespaceObject.addHexPrefix)(TWENTY_ONE_THOUSAND.toString(16)));
              case 11:
                _context11.next = 13;
              ...
              case 13:
                ...
                gasLimit = this.addGasBuffer((0,util_namespaceObject.addHexPrefix)(estimatedGasHex), blockGasLimit);
