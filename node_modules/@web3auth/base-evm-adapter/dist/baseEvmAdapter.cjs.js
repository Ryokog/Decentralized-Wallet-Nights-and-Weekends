...
var BaseEvmAdapter = /*#__PURE__*/function (_BaseAdapter) {
  ...
  createClass_default()(BaseEvmAdapter, [{
    key: "init",
    value: function () {
      var _init = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(_) {
    ...
    value: function () {
      var _authenticateUser = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2() {
        ...
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!(!this.provider || this.status !== base_namespaceObject.ADAPTER_STATUS.CONNECTED)) {
                  _context2.next = 2;
                  break;
                }
              ...
              case 18:
                ...
                _context2.next = 21;
                return (0,base_namespaceObject.verifySignedChallenge)(chainNamespace, signedMessage, challenge, this.name, this.sessionTime, this.clientId, this.web3AuthNetwork);
              case 21:
    ...
    value: function () {
      var _disconnectSession = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3() {
        var accounts;
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                get_default()(getPrototypeOf_default()(BaseEvmAdapter.prototype), "checkDisconnectionRequirements", this).call(this);
                _context3.next = 3;
                return this.provider.request({
                  method: "eth_accounts"
                });
