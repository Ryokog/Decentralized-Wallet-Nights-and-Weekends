...
var OPENLOGIN_PROVIDERS_NAMES = OPENLOGIN_PROVIDERS.reduce(function (acc, x) {
...
var modal = {
	...
	"header-tooltip-desc": "Every user needs a wallet to store and manage their digital assets. Connect your wallet to an application to get started.",
...
function Icon(props) {
  var iconName = props.iconName,
    _props$iconTitle = props.iconTitle,
    iconTitle = _props$iconTitle === void 0 ? "" : _props$iconTitle,
...
function Image$1(props) {
  var hoverImageId = props.hoverImageId,
  ...
  return jsxs(Fragment, {
    children: [jsx("img", {
      ...
      src: "https://images.web3auth.io/".concat(hoverImageId, ".svg"),
      height: height,
      width: width,
      alt: hoverImageId,
...
function WalletConnect(props) {
  ...
  return jsx("div", Object.assign({
    ...
    children: jsx("div", Object.assign({
      ...
      children: deviceDetails.platform === bowser.PLATFORMS_MAP.desktop ? jsxs("div", Object.assign({
        ...
        children: [jsx("div", {
          ...
          onClick: function onClick() {
            return copyToClipboard(walletConnectUri);
          },
    ...
    children: jsxs("div", Object.assign({
      ...
      children: [showBackButton && jsxs("button", Object.assign({
        ...
        children: Object.keys(config).map(function (adapter) {
          ...
          var providerIcon = jsx(Image$1, {
            imageId: "login-".concat(adapter),
            hoverImageId: "login-".concat(adapter),
            isButton: true
          });
          return adapterVisibilityMap[adapter] && jsx("li", Object.assign({
            ...
            children: jsx("button", Object.assign({
              ...
              title: ((_a = config[adapter]) === null || _a === void 0 ? void 0 : _a.label) || adapter
            }, {
              children: providerIcon
            }))
          }), adapter);
      ...
      children: [!appLogo ? jsx("img", {
        ...
        children: [jsx("div", Object.assign({
          ...
          children: [t("modal.header-subtitle-name", {
            ...
            children: [jsx(Icon, {
              iconName: "information-circle".concat(isDark ? "-light" : "")
            }), jsxs("div", Object.assign({
    ...
    children: [jsx("div", Object.assign({
      ...
      children: [jsx("input", {
        ...
        onBlur: function onBlur(e) {
          return e.target.placeholder = t("modal.social.email-new");
        },
...
function SocialLogins(props) {
  ...
  var adapterExpandText = isExpanded ? t("modal.social.view-less-new") : t("modal.social.view-more-new");
  return jsxs("div", Object.assign({
    ...
    children: [jsx("ul", Object.assign({
      ...
      children: Object.keys(socialLoginsConfig.loginMethods).map(function (method) {
        var name = capitalizeFirstLetter(socialLoginsConfig.loginMethods[method].name || method);
        var providerIcon = jsx(Image$1, {
          width: "20",
          imageId: "login-".concat(method).concat(isDark ? "-light" : "-dark"),
          hoverImageId: "login-".concat(method, "-active"),
          isButton: true
        });
...
function Modal(props) {
  ...
  var preHandleSocialWalletClick = function preHandleSocialWalletClick(params) {
    var loginParams = params.loginParams;
    setModalState(function (prevState) {
      return Object.assign(Object.assign({}, prevState), {
  ...
  var modalClassName = "w3a-modal ".concat(isDark ? "" : "");
...
var LoginModal = /*#__PURE__*/function (_SafeEventEmitter) {
  ...
  function LoginModal(_ref) {
    ...
    var appName = _ref.appName,
      ...
      modalZIndex = _ref$modalZIndex === void 0 ? "99998" : _ref$modalZIndex;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (useLang === "de") {
                  import('./german-4ae5331e.js').then(function (messages) {
                  ...
                  import('./japanese-2621b294.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                  ...
                  import('./korean-49a32b2a.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                  ...
                  import('./mandarin-8afb0cdc.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                  ...
                  import('./spanish-3310095f.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                  ...
                  import('./french-3844ee4a.js').then(function (messages) {
                    i18n.addResourceBundle(useLang, "translation", messages.default);
                    return i18n.changeLanguage(useLang);
                  }).catch(function (error) {
                    log.error(error);
                ...
                return _context.abrupt("return", new Promise(function (resolve) {
                  ...
                  var container = createWrapper$1(_this2.modalZIndex);
                  if (darkState.isDark) {
    ...
    _this.appName = appName || "blockchain";
    _this.modalZIndex = modalZIndex || "99998";
    // set theme
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  var container = createWrapper("w3a-add-network-container");
                  var networkRoot = createRoot(container);
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  var networkSwitchContainer = createWrapper("w3a-switch-network-container");
                  var networkRoot = createRoot(networkSwitchContainer);
...
export { LOGIN_MODAL_EVENTS, LoginModal, MODAL_STATUS, NetworkSwitch, OPENLOGIN_PROVIDERS, OPENLOGIN_PROVIDERS_NAMES, capitalizeFirstLetter, LoginModal as default, getAdapterSocialLogins, getNetworkIconId, languageMap, validateImageUrl };
