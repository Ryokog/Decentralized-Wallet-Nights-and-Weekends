  ...
  createClass_default()(Web3AuthCore, [{
                ...
                initPromises = Object.keys(this.walletAdapters).map(function (adapterName) {
                  ...
                  if (!_this2.walletAdapters[adapterName].chainConfigProxy) {
                    ...
                    _this2.walletAdapters[adapterName].setAdapterSettings({
                      ...
                      web3AuthNetwork: _this2.coreOptions.web3AuthNetwork
                    });
                  } else {
                    _this2.walletAdapters[adapterName].setAdapterSettings({
                      sessionTime: _this2.coreOptions.sessionTime,
    ...
    value: function subscribeToAdapterEvents(walletAdapter) {
      ...
      walletAdapter.on(base_namespaceObject.ADAPTER_EVENTS.CONNECTED, /*#__PURE__*/function () {
        var _ref = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee8(data) {
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  ...
                  _context8.next = 6;
                  return Promise.all(Object.values(_this3.plugins).map( /*#__PURE__*/function () {
                    var _ref2 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee7(plugin) {
                      return regenerator_default().wrap(function _callee7$(_context7) {
                        while (1) {
                          switch (_context7.prev = _context7.next) {
                            ...
                            case 3:
                              _context7.next = 5;
                              return plugin.initWithWeb3Auth(_this3);
                            case 5:
                              _context7.next = 7;
      ...
      walletAdapter.on(base_namespaceObject.ADAPTER_EVENTS.DISCONNECTED, /*#__PURE__*/function () {
        var _ref3 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee9(data) {
          var cachedAdapter;
