  ...
  createClass_default()(SolanaWalletAdapter, [{
        ...
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return get_default()(getPrototypeOf_default()(SolanaWalletAdapter.prototype), "init", this).call(this, options);
              case 2:
    ...
    value: function () {
      var _connect = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2() {
        var torusInpageProvider, _ref2, chainId, blockExplorer, displayName, rpcTarget, ticker, tickerName, network;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 20:
                ...
                _ref2 = this.chainConfig, chainId = _ref2.chainId, blockExplorer = _ref2.blockExplorer, displayName = _ref2.displayName, rpcTarget = _ref2.rpcTarget, ticker = _ref2.ticker, tickerName = _ref2.tickerName;
                network = {
                  chainId: chainId,
                  rpcTarget: rpcTarget,
                  blockExplorerUrl: blockExplorer,
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return get_default()(getPrototypeOf_default()(SolanaWalletAdapter.prototype), "disconnectSession", this).call(this);
              case 3:
                if (this.torusInstance) {
                  _context3.next = 5;
                  break;
