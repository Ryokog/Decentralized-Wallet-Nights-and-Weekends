...
var getOpenloginDefaultOptions = function getOpenloginDefaultOptions() {
  return {
    adapterSettings: {
...
var OpenloginAdapter = /*#__PURE__*/function (_BaseAdapter) {
  ...
  function OpenloginAdapter(params) {
    ...
    _this.setAdapterSettings(_objectSpread(_objectSpread({}, params.adapterSettings), {}, {
  ...
  createClass_default()(OpenloginAdapter, [{
        ...
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                if (this.openloginOptions) {
                  _context.next = 5;
                  break;
                }
                throw base_namespaceObject.WalletInitializationError.invalidParams("openloginOptions is required before openlogin's initialization");
              case 5:
    ...
    value: function setAdapterSettings(adapterSettings) {
      get_default()(getPrototypeOf_default()(OpenloginAdapter.prototype), "setAdapterSettings", this).call(this, adapterSettings);
        ...
        return regenerator_default().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 26:
                if (!(!this.openloginInstance.privKey || (_params$extraLoginOpt = params.extraLoginOptions) !== null && _params$extraLoginOpt !== void 0 && _params$extraLoginOpt.id_token)) {
                  _context6.next = 30;
                  break;
                }
