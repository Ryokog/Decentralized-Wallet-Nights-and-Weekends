  ...
  _createClass(BaseSolanaAdapter, [{
    ...
    value: function () {
      var _authenticateUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
        var _this$chainConfig, chainNamespace, chainId, accounts, existingToken, isExpired, payload, challenge, encodedMessage, signedMessage, idToken;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 19:
                ...
                _context2.next = 22;
                return verifySignedChallenge(chainNamespace, bs58.encode(signedMessage), challenge, this.name, this.sessionTime, this.clientId, this.web3AuthNetwork);
              case 22:
        ...
        return _regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _get(_getPrototypeOf(BaseSolanaAdapter.prototype), "checkDisconnectionRequirements", this).call(this);
                _context3.next = 3;
                return this.provider.request({
                  method: "getAccounts"
                });
