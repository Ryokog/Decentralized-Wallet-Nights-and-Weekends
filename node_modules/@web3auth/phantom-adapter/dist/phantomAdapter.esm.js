...
import { WALLET_ADAPTERS, ADAPTER_NAMESPACES, CHAIN_NAMESPACES, ADAPTER_CATEGORY, ADAPTER_STATUS, ADAPTER_EVENTS, log, WalletInitializationError, WalletLoginError, Web3AuthError } from '@web3auth/base';
        ...
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _get(_getPrototypeOf(PhantomAdapter.prototype), "init", this).call(this, options);
              case 2:
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return _get(_getPrototypeOf(PhantomAdapter.prototype), "disconnectSession", this).call(this);
              case 3:
                _context4.prev = 3;
                _context4.next = 6;
