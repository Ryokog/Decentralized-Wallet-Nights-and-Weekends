  ...
  createClass_default()(TorusWalletAdapter, [{
    ...
    value: function () {
      var _init = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(options) {
        var _ref, chainId, blockExplorer, displayName, rpcTarget, ticker, tickerName, network;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return get_default()(getPrototypeOf_default()(TorusWalletAdapter.prototype), "init", this).call(this, options);
              case 2:
                get_default()(getPrototypeOf_default()(TorusWalletAdapter.prototype), "checkInitializationRequirements", this).call(this);
                _ref = this.chainConfig, chainId = _ref.chainId, blockExplorer = _ref.blockExplorer, displayName = _ref.displayName, rpcTarget = _ref.rpcTarget, ticker = _ref.ticker, tickerName = _ref.tickerName;
                network = {
    ...
    value: function () {
      var _connect = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2() {
        var chainId, _ref2, _chainId, blockExplorer, displayName, rpcTarget, ticker, tickerName, network, updatedChainID;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                _ref2 = this.chainConfig, _chainId = _ref2.chainId, blockExplorer = _ref2.blockExplorer, displayName = _ref2.displayName, rpcTarget = _ref2.rpcTarget, ticker = _ref2.ticker, tickerName = _ref2.tickerName;
                network = {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return get_default()(getPrototypeOf_default()(TorusWalletAdapter.prototype), "disconnectSession", this).call(this);
              case 3:
                if (this.torusInstance) {
                  _context3.next = 5;
                  break;
