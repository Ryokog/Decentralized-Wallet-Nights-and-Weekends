...
import { WALLET_ADAPTERS, ADAPTER_NAMESPACES, CHAIN_NAMESPACES, ADAPTER_CATEGORY, ADAPTER_STATUS, log, ADAPTER_EVENTS, Web3AuthError, WalletLoginError, WalletInitializationError } from '@web3auth/base';
  ...
  _createClass(TorusWalletAdapter, [{
    ...
    value: function () {
      var _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(options) {
        var _this$chainConfig, chainId, blockExplorer, displayName, rpcTarget, ticker, tickerName, network;
        return _regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _get(_getPrototypeOf(TorusWalletAdapter.prototype), "init", this).call(this, options);
              case 2:
                _get(_getPrototypeOf(TorusWalletAdapter.prototype), "checkInitializationRequirements", this).call(this);
                _this$chainConfig = this.chainConfig, chainId = _this$chainConfig.chainId, blockExplorer = _this$chainConfig.blockExplorer, displayName = _this$chainConfig.displayName, rpcTarget = _this$chainConfig.rpcTarget, ticker = _this$chainConfig.ticker, tickerName = _this$chainConfig.tickerName;
                network = {
    ...
    value: function () {
      var _connect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
        var chainId, _this$chainConfig2, _chainId, blockExplorer, displayName, rpcTarget, ticker, tickerName, network, updatedChainID;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                _this$chainConfig2 = this.chainConfig, _chainId = _this$chainConfig2.chainId, blockExplorer = _this$chainConfig2.blockExplorer, displayName = _this$chainConfig2.displayName, rpcTarget = _this$chainConfig2.rpcTarget, ticker = _this$chainConfig2.ticker, tickerName = _this$chainConfig2.tickerName;
                network = {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return _get(_getPrototypeOf(TorusWalletAdapter.prototype), "disconnectSession", this).call(this);
              case 3:
                if (this.torusInstance) {
                  _context3.next = 5;
                  break;
