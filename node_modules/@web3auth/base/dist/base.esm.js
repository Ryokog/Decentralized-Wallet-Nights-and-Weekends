...
var ADAPTER_NAMES = (_ADAPTER_NAMES = {}, _defineProperty(_ADAPTER_NAMES, MULTI_CHAIN_ADAPTERS.OPENLOGIN, "OpenLogin"), _defineProperty(_ADAPTER_NAMES, MULTI_CHAIN_ADAPTERS.WALLET_CONNECT_V1, "Wallet Connect v1"), _defineProperty(_ADAPTER_NAMES, MULTI_CHAIN_ADAPTERS.WALLET_CONNECT_V2, "Wallet Connect v2"), _defineProperty(_ADAPTER_NAMES, SOLANA_ADAPTERS.TORUS_SOLANA, "Torus"), _defineProperty(_ADAPTER_NAMES, SOLANA_ADAPTERS.PHANTOM, "Phantom"), _defineProperty(_ADAPTER_NAMES, SOLANA_ADAPTERS.SOLFLARE, "Solflare"), _defineProperty(_ADAPTER_NAMES, SOLANA_ADAPTERS.SLOPE, "Slope"), _defineProperty(_ADAPTER_NAMES, EVM_ADAPTERS.TORUS_EVM, "Torus"), _defineProperty(_ADAPTER_NAMES, EVM_ADAPTERS.METAMASK, "Metamask"), _defineProperty(_ADAPTER_NAMES, EVM_ADAPTERS.COINBASE, "Coinbase"), _ADAPTER_NAMES);
...
var BaseAdapter = /*#__PURE__*/function (_SafeEventEmitter) {
  ...
  function BaseAdapter() {
    ...
    _defineProperty(_assertThisInitialized(_this), "web3AuthNetwork", OPENLOGIN_NETWORK.MAINNET);
  ...
  _createClass(BaseAdapter, [{
    ...
    value: function setAdapterSettings(options) {
      ...
      if (customChainConfig) {
        ...
        var finalChainConfig = _objectSpread(_objectSpread({}, defaultChainConfig || {}), customChainConfig);
...
var verifySignedChallenge = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(chainNamespace, signedMessage, challenge, issuer, sessionTime, clientId, web3AuthNetwork) {
