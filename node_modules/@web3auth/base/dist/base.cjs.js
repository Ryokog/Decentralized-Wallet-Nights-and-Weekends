...
var ADAPTER_NAMES = (_ADAPTER_NAMES = {}, defineProperty_default()(_ADAPTER_NAMES, MULTI_CHAIN_ADAPTERS.OPENLOGIN, "OpenLogin"), defineProperty_default()(_ADAPTER_NAMES, MULTI_CHAIN_ADAPTERS.WALLET_CONNECT_V1, "Wallet Connect v1"), defineProperty_default()(_ADAPTER_NAMES, MULTI_CHAIN_ADAPTERS.WALLET_CONNECT_V2, "Wallet Connect v2"), defineProperty_default()(_ADAPTER_NAMES, SOLANA_ADAPTERS.TORUS_SOLANA, "Torus"), defineProperty_default()(_ADAPTER_NAMES, SOLANA_ADAPTERS.PHANTOM, "Phantom"), defineProperty_default()(_ADAPTER_NAMES, SOLANA_ADAPTERS.SOLFLARE, "Solflare"), defineProperty_default()(_ADAPTER_NAMES, SOLANA_ADAPTERS.SLOPE, "Slope"), defineProperty_default()(_ADAPTER_NAMES, EVM_ADAPTERS.TORUS_EVM, "Torus"), defineProperty_default()(_ADAPTER_NAMES, EVM_ADAPTERS.METAMASK, "Metamask"), defineProperty_default()(_ADAPTER_NAMES, EVM_ADAPTERS.COINBASE, "Coinbase"), _ADAPTER_NAMES);
...
var BaseAdapter = /*#__PURE__*/function (_SafeEventEmitter) {
  ...
  function BaseAdapter() {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "web3AuthNetwork", openlogin_namespaceObject.OPENLOGIN_NETWORK.MAINNET);
    ...
    _this.setAdapterSettings(options);
    return _this;
  }
  createClass_default()(BaseAdapter, [{
    ...
    value: function setAdapterSettings(options) {
      ...
      var customChainConfig = options.chainConfig;
      if (customChainConfig) {
        ...
        var finalChainConfig = IAdapter_objectSpread(IAdapter_objectSpread({}, defaultChainConfig || {}), customChainConfig);
    ...
    key: "checkDisconnectionRequirements",
    value: function checkDisconnectionRequirements() {
...
var verifySignedChallenge = /*#__PURE__*/function () {
  var _ref2 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(chainNamespace, signedMessage, challenge, issuer, sessionTime, clientId, web3AuthNetwork) {
  ...
  return function verifySignedChallenge(_x3, _x4, _x5, _x6, _x7, _x8, _x9) {
